        ...
        <Container className="py-12 sm:py-16 md:py-20">
          <article className="max-w-4xl mx-auto">
            ...
            <div className="mb-4 text-center">
              <time className="text-xs text-[#D4A72C] font-bold tracking-wider uppercase">
                {formatDate(article.publishedDate)}
              </time>
            </div>

            {/* Title */}
            <h1 className="font-bebas text-4xl sm:text-5xl md:text-6xl text-[#031A34] uppercase text-center leading-tight mb-8">
              {article.title}
            </h1>
            ...
            <div className="prose prose-sm sm:prose-base md:prose-lg max-w-none mx-auto
              prose-headings:font-bebas prose-headings:text-[#031A34] prose-headings:uppercase
              prose-h2:text-2xl sm:prose-h2:text-3xl prose-h2:mt-8 prose-h2:mb-4 prose-h2:text-[#D4A72C]
              prose-p:text-sm sm:prose-p:text-base prose-p:text-gray-700 prose-p:leading-relaxed prose-p:mb-5
              prose-strong:text-[#031A34] prose-strong:font-bold
              prose-a:text-[#D4A72C] prose-a:no-underline hover:prose-a:underline
            ...
            <div className="text-center">
              <Link
                href="/articles"
                className="inline-flex items-center gap-2 px-6 py-2.5 bg-[#D4A72C] hover:bg-[#031A34] text-white text-xs font-bold uppercase tracking-wider transition-all duration-300 rounded-sm shadow-sm"
              >
            ...
            {relatedArticles.length > 0 && (
              <div className="mt-16 pt-8 border-t border-gray-200">
                <h3 className="font-bebas text-3xl text-[#031A34] uppercase mb-8 text-center font-bold">
                  You Might Also Like
                </h3>
                  ...
                  {relatedArticles.map((relatedArticle) => (
                    ...
                    >
                      ...
                      <div className="p-5 font-sans space-y-2">
                        <time className="text-[10px] text-[#D4A72C] font-bold uppercase tracking-wider">
                          {formatDate(relatedArticle.publishedDate)}
                        </time>
                        <h4 className="font-bebas text-xl text-[#031A34] uppercase line-clamp-2 group-hover:text-[#D4A72C] transition-colors duration-300 font-bold">
