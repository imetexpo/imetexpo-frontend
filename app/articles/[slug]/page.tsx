        ...
        <Container className="py-12 sm:py-16 md:py-20">
          <article className="max-w-4xl mx-auto">
            ...
            <div className="mb-4 text-center">
              <time className="text-xs text-[#F9B122] font-bold tracking-wider uppercase">
            ...
            <div className="prose prose-sm sm:prose-base md:prose-lg max-w-none mx-auto
              ...
              prose-h2:text-2xl sm:prose-h2:text-3xl prose-h2:mt-8 prose-h2:mb-4 prose-h2:text-[#F9B122]
              ...
              prose-a:text-[#F9B122] prose-a:no-underline hover:prose-a:underline
            ...
            <div className="text-center">
              <Link
                href="/articles"
                className="inline-flex items-center gap-2 px-6 py-2.5 bg-[#F9B122] hover:bg-[#031A34] text-white text-xs font-bold uppercase tracking-wider transition-all duration-300 rounded-sm shadow-sm"
              >
                  ...
                  {relatedArticles.map((relatedArticle) => (
                    ...
                    >
                      ...
                      <div className="p-5 font-sans space-y-2">
                        <time className="text-[10px] text-[#F9B122] font-bold uppercase tracking-wider">
                          {formatDate(relatedArticle.publishedDate)}
                        </time>
                        <h4 className="font-bebas text-xl text-[#031A34] uppercase line-clamp-2 group-hover:text-[#F9B122] transition-colors duration-300 font-bold">
