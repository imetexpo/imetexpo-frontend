    ...
    <div className="intro-animation">
      <div className="page-spacing-wrapper">
        <div className="lg:pt-0">
                ...
                <div className="grid items-center gap-10 overflow-hidden lg:grid-cols-5 lg:gap-20">
                  <div className="lg:col-span-5">
                    <div className="flex flex-col gap-5">
                      <p className="font-bold text-[#B89646]">Your Gateway to Precision Manufacturing Growth in India</p>
                    ...
                    <div className="mt-10 flex flex-wrap gap-8 2xl:gap-16">
                      <div className="flex w-fit flex-col justify-center border-r border-gray-200 pr-8 font-bebas last-of-type:border-none 2xl:pr-16">
                        <h3 className="mb-3 text-5xl font-bold text-[#B89646] md:text-6xl">1st</h3>
                        <p className="text-sm font-semibold tracking-wider uppercase text-[#0E2044] font-sans">Edition</p>
                      </div>
                      <div className="flex w-fit flex-col justify-center border-r border-gray-200 pr-8 font-bebas last-of-type:border-none 2xl:pr-16">
                        <h3 className="mb-3 text-5xl font-bold text-[#B89646] md:text-6xl">10,000+</h3>
                        <p className="text-sm font-semibold tracking-wider uppercase text-[#0E2044] font-sans">Trade Visitors</p>
                      </div>
                      <div className="flex w-fit flex-col justify-center border-r border-gray-200 pr-8 font-bebas last-of-type:border-none 2xl:pr-16">
                        <h3 className="mb-3 text-5xl font-bold text-[#B89646] md:text-6xl">150+</h3>
                      ...
                      <div className="flex w-fit flex-col justify-center font-bebas last-of-type:border-none lg:border-r lg:pr-8 2xl:pr-16">
                        <h3 className="mb-3 text-5xl font-bold text-[#B89646] md:text-6xl">50+</h3>
                    ...
                    <div className="mt-10">
                      <Link href="/about-its-tyre-expo">
                        <button className="bg-[#B89646] hover:bg-[#0E2044] text-white px-8 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm">
                          About INDIAMET Expo
                        </button>
                      </Link>
                    </div>
            ...
            <div className="animated-block-target">
              <Container>
                ...
                <Link href="/exhibiting-enquiry">
                  <button className="bg-[#B89646] hover:bg-[#0E2044] text-white px-8 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm">Book A Stand</button>
                </Link>
              </Container>
            </div>
          </div>
                  ...
                  <div className="lg:col-span-3">
                    ...
                    <div className="mt-10 grid grid-cols-2 gap-6 bg-[#FCF8F3] border border-gray-100 p-8 rounded-sm font-sans">
                      <div className="flex w-fit flex-col">
                        <h3 className="mb-3 text-5xl font-bold text-[#B89646] font-bebas">68%</h3>
                        <p className="text-sm font-semibold uppercase text-[#0E2044]">Industry Decision-Makers</p>
                      </div>
                      <div className="flex w-fit flex-col">
                        <h3 className="mb-3 text-5xl font-bold text-[#B89646] font-bebas">72%</h3>
                        <p className="text-sm font-semibold uppercase text-[#0E2044]">Manufacturing & Engineering Professionals</p>
                      </div>
                      <div className="flex w-fit flex-col">
                        <h3 className="mb-3 text-5xl font-bold text-[#B89646] font-bebas">45%</h3>
                        <p className="text-sm font-semibold uppercase text-[#0E2044]">Procurement & Purchase Influencers</p>
                      </div>
                      <div className="flex w-fit flex-col">
                        <h3 className="mb-3 text-5xl font-bold text-[#B89646] font-bebas">30%</h3>
                        <p className="text-sm font-semibold uppercase text-[#0E2044]">Senior Management & C-Level Executives</p>
                      </div>
                    </div>
                    <div className="mt-10">
                      <Link href="/exhibiting-enquiry">
                        <button className="bg-[#B89646] hover:bg-[#0E2044] text-white px-8 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm">Enquire to Exhibit</button>
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="grid items-center gap-10 md:grid-cols-12">
                    ...
                    <div className="flex flex-col gap-5 md:col-span-8">
                      ...
                      <Link href="/event-brochure">
                        <button className="bg-[#B89646] hover:bg-white hover:text-[#0E2044] text-white px-8 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm">
                          Download Now
                        </button>
                      </Link>
                    </div>
              ...
              <Container>
                <div className="mb-10 flex justify-between max-lg:flex-col lg:items-end">
                  <div className="lg:basis-2/3">
                    <p className="font-bold text-[#B89646]">Testimonials</p>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {[
                    ...
                    <div key={idx} className="relative flex h-full flex-col overflow-hidden rounded-sm bg-[#FCF8F3] border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow duration-300 font-sans">
                      <div className="text-4xl mb-4 text-[#B89646] font-serif">&ldquo;</div>
                      ...
                      <div className="mt-6 flex items-center gap-4 border-t border-gray-200 pt-5">
                        <div className="h-12 w-12 rounded-sm bg-gradient-to-br from-[#B89646] to-orange-600 flex items-center justify-center text-white font-bold text-lg">
          ...
          {/* <div className="animated-block mt-20">
            <div className="animated-block-target">
              <div className="border-t-8 border-[#B89646] bg-[#0E2044] py-20 text-white">
                <Container>
          ...
          {/* <hr className="border-t-6 border-[#B89646]" /> */}
        </div>
        <BackToTop />
      </div>
