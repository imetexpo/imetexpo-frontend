export default function SponsorContent() {
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 className="text-3xl font-bold text-[#D4A72C] mb-4 font-bebas">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-[#f5f5f5] p-4 rounded-xl text-center">
          <p className="text-3xl font-bold text-[#D4A72C] font-bebas">50+</p>
          <p className="text-sm text-gray-600">Exhibitors</p>
        </div>
        <div className="bg-[#f5f5f5] p-4 rounded-xl text-center">
          <p className="text-3xl font-bold text-[#D4A72C] font-bebas">30+</p>
          <p className="text-sm text-gray-600">Speakers</p>
        </div>
        <div className="bg-[#f5f5f5] p-4 rounded-xl text-center">
          <p className="text-3xl font-bold text-[#D4A72C] font-bebas">500+</p>
          <p className="text-sm text-gray-600">Delegates</p>
        </div>
        <div className="bg-[#f5f5f5] p-4 rounded-xl text-center">
          <p className="text-3xl font-bold text-[#D4A72C] font-bebas">15+</p>
        ...
        <ul className="space-y-3">
          {[
            ...
            <li key={index} className="flex items-start gap-3">
              <svg className="w-5 h-5 text-[#D4A72C] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
