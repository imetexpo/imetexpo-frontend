  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {productSectors.map((sector, index) => (
              <label key={index} className="flex items-start gap-2 cursor-pointer hover:bg-gray-50 p-1 rounded-sm">
                <input
                  ...
                  className="mt-0.5 w-4 h-4 text-[#B89646] rounded-sm border-gray-300 focus:ring-[#B89646]"
                />
      ...
      <p className="text-xs text-gray-500 text-center leading-relaxed mt-4">
        ...
        please refer to our
        <Link href="/privacy-policy" className="text-[#B89646] hover:underline ml-1 font-semibold">
          Privacy Policy
        </Link>
        .
      </p>
