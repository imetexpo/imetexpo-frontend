  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto rounded-2xl bg-orange-50/30 p-6 md:p-8 border border-orange-200 shadow-lg">
        <h2 className="text-2xl md:text-3xl font-bold text-[#B89646] mb-6">Partner Registration Form</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              ...
              <input 
                ...
                required
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#B89646] focus:border-[#B89646] outline-none transition-all bg-white"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Email <span className="text-[#B89646]">*</span>
              </label>
              <input 
                type="email" 
                name="email"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Mobile Phone <span className="text-[#B89646]">*</span>
            </label>
            <div className="flex">
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="flex-1 px-4 py-2.5 border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-[#B89646] focus:border-[#B89646] outline-none transition-all bg-white"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Address <span className="text-[#B89646]">*</span>
              </label>
              <textarea 
                name="address"
                ...
                required
                rows={2}
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#B89646] focus:border-[#B89646] outline-none transition-all bg-white resize-none"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Pincode <span className="text-[#B89646]">*</span>
              </label>
              <input 
                type="text" 
                name="pincode"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Partnership Type <span className="text-[#B89646]">*</span>
              </label>
              <select
          ...
          <div className="space-y-4 pt-4">
            <div className="flex items-start gap-3 p-4 bg-white rounded-lg border border-gray-200">
              <input 
                ...
                onChange={handleChange}
                className="mt-1 h-5 w-5 border-gray-300 rounded focus:ring-[#B89646] text-[#B89646]"
              />
            ...
            <div className="flex items-start gap-3 p-4 bg-white rounded-lg border border-gray-200">
              ...
              <label htmlFor="consent" className="text-sm text-gray-600 leading-relaxed cursor-pointer">
                ...
                with the <a href="/privacy-policy" className="text-[#B89646] hover:text-[#d97000] underline font-medium">Personal Data Policy</a>.
                <span className="text-[#B89646] ml-1">*</span>
              </label>
            </div>
          </div>
          ...
          <button
            ...
            className={`w-full bg-[#B89646] hover:bg-[#d97000] text-white font-semibold py-3 px-4 rounded-lg transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#B89646] focus:ring-offset-2 ${
          ...
          <p className="text-xs text-gray-500 mt-3 text-center">
            All fields marked with <span className="text-[#B89646]">*</span> are required
          </p>
        </form>
      </div>
    </>
