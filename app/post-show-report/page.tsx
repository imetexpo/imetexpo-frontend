  ...
  return (
    <div className="space-y-1">
      ...
      <input
        ...
        required={required}
        className="w-full px-4 py-2 border border-gray-300 rounded-sm focus:ring-1 focus:ring-[#B89646] focus:border-[#B89646] outline-none transition bg-white text-sm"
      />
    </div>
  );
}
  ...
  return (
    <div className="space-y-1">
      ...
      <select
        ...
        onChange={onChange}
        required={required}
        className="w-full px-4 py-2 border border-gray-300 rounded-sm focus:ring-1 focus:ring-[#B89646] focus:border-[#B89646] outline-none transition bg-white text-sm cursor-pointer"
      >
          ...
          {options.map((option) => (
            <label key={option} className="flex items-start gap-2 cursor-pointer hover:bg-gray-50 p-1 rounded-sm">
              <input
                ...
                className="mt-0.5 w-4 h-4 text-[#B89646] focus:ring-[#B89646] rounded-sm border-gray-300"
              />
        ...
        <Container>
          <div className="bg-[#FCF8F3] border border-gray-100 rounded-sm p-8 max-w-md text-center shadow-sm mx-auto">
            <div className="w-16 h-16 bg-white border border-gray-150 rounded-sm flex items-center justify-center mx-auto mb-6">
              <svg className="w-8 h-8 text-[#B89646]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/">
              <button className="bg-[#B89646] hover:bg-[#0E2044] text-white px-8 py-3 text-xs font-bold uppercase tracking-wider transition-all duration-300 rounded-sm cursor-pointer">
                Back to Home
              </button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[42%_58%] gap-12 items-start">
            ...
            <div className="flex flex-col gap-6 lg:sticky h-fit lg:top-[calc(var(--site-header-height,13.75rem)+1rem)]">
              <div className="space-y-3">
                <p className="text-[#B89646] text-xs font-bold uppercase tracking-wider">
                  Post-Show Report
                </p>
                
                <h1 className="font-bebas text-5xl sm:text-6xl leading-[1.05] tracking-tight uppercase text-[#0E2044]">
                  INDIAMET Expo <span className="text-[#B89646]">Post-Show Report</span>
                </h1>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 bg-[#FCF8F3] border border-gray-100 p-6 rounded-sm shadow-sm">
                {statsData.map((stat, idx) => (
                  <div key={idx} className="text-center">
                    <h3 className="text-3xl font-bebas text-[#B89646] uppercase font-bold">
                      {stat.value}
                    </h3>
              ...
              <div className="space-y-4 pt-4 border-t border-gray-200">
                <h3 className="font-bebas text-2xl text-[#0E2044] uppercase font-bold">
            ...
            <div className="bg-[#FCF8F3] border border-gray-100 rounded-sm p-6 md:p-8 shadow-sm">
              <div className="mb-6">
                <h2 className="text-[#0E2044] font-bebas text-3xl font-bold uppercase tracking-wide">
                  Download Expo <span className="text-[#B89646]">Brochure</span>
                </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-sm">
                  <input
                    ...
                    className="w-4 h-4 text-[#B89646] focus:ring-[#B89646] rounded-sm border-gray-300 cursor-pointer"
                    required
                  />
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full bg-[#B89646] hover:bg-[#0E2044] text-white py-3 text-xs font-bold uppercase tracking-wider transition-all duration-300 rounded-sm disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                  >
                ...
                <p className="text-xs text-gray-500 text-center leading-relaxed mt-4">
                  ...
                  <Link href="/privacy-policy" className="text-[#B89646] hover:underline ml-1 font-semibold">Privacy Policy</Link>.
                </p>
              </form>
            </div>
