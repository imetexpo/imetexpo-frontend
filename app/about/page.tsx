              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="mt-8 sm:mt-10 flex flex-wrap items-center justify-between bg-[#FCF8F3] border border-gray-100 px-4 sm:px-6 py-6 sm:py-8 rounded-sm gap-4 sm:gap-0">
                  <div className="text-center flex-1 min-w-[80px]">
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bebas text-[#B89646] font-bold">1st</h3>
                  ...
                  <div className="text-center flex-1 min-w-[80px]">
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bebas text-[#B89646] font-bold">10,000+</h3>
                  ...
                  <div className="text-center flex-1 min-w-[80px]">
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bebas text-[#B89646] font-bold">150+</h3>
                  ...
                  <div className="text-center flex-1 min-w-[80px]">
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bebas text-[#B89646] font-bold">50+</h3>
                ...
                <div className="mt-8 sm:mt-10">
                  <Link href="/why-exhibit">
                    <button className="bg-[#B89646] hover: text-white px-8 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm">
                      Why Exhibit
                    </button>
                  </Link>
                </div>
                    ...
                    <div className="grid items-center gap-8 md:grid-cols-12">
                      ...
                      <div className="flex flex-col gap-4 sm:gap-5 md:col-span-7 lg:col-span-8">
                        ...
                        <Link href="/event-brochure">
                          <button className="bg-[#B89646] hover:bg-white hover:text-[#0E2044] text-white px-8 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm w-fit">
                            Download Now
                          </button>
                        </Link>
                      </div>
                        ...
                        <div className="flex flex-col gap-3 sm:gap-4 p-4 sm:p-5 font-sans">
                          ...
                          {event.buttonText && (
                            <Link href={event.buttonLink}>
                              <button className="bg-[#B89646] hover:bg-[#0E2044] text-white px-6 py-2.5 text-xs font-bold uppercase tracking-wider transition-all duration-300 rounded-sm w-fit mt-2">
                                {event.buttonText}
                              </button>
                            </Link>
                          )}
