...
const inputClass =
  'w-full rounded-sm border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-[#F9B122] focus:ring-1 focus:ring-[#F9B122] disabled:cursor-not-allowed disabled:bg-gray-100';
...
export default function DelegateForm({ selectedPackage = '' }: { selectedPackage?: string }) {
    ...
    return (
      <div className="rounded-sm border border-gray-100 bg-white p-8 text-center shadow-sm">
        ...
        <button
          ...
          className="mt-6 rounded-sm bg-[#F9B122] px-6 py-3 text-xs font-bold uppercase tracking-wider text-white transition-all duration-300 hover:bg-[#031A34]"
        >
  ...
  return (
    <>
      ...
      >
        <h3 className="border-b border-gray-100 pb-3 font-bebas text-2xl uppercase tracking-wide text-[#F9B122]">
        ...
        <div>
          <label className="mb-1 block text-xs font-bold uppercase tracking-wider text-gray-700">
            Work Email <span className="text-[#F9B122]">*</span>
          </label>
          <input
            type="email"
            name="email"
        ...
        <div>
          <label className="mb-1 block text-xs font-bold uppercase tracking-wider text-gray-700">
            Phone <span className="text-[#F9B122]">*</span>
          </label>
          <input
            type="tel"
            name="phone"
        ...
        <div>
          <label className="mb-1 block text-xs font-bold uppercase tracking-wider text-gray-700">
            Country <span className="text-[#F9B122]">*</span>
          </label>
          <select
            name="country"
        ...
        <div>
          <label className="mb-1 block text-xs font-bold uppercase tracking-wider text-gray-700">
            Select Package <span className="text-[#F9B122]">*</span>
          </label>
          <select
            name="package"
        ...
        <label className="flex items-start gap-2 text-sm text-gray-700">
          ...
          />
          <span>
            I confirm that I am not a robot <span className="text-[#F9B122]">*</span>
          </span>
        </label>
        ...
        <button
          ...
          className={`rounded-sm bg-[#F9B122] px-6 py-3 text-xs font-bold uppercase tracking-wider text-white transition-all duration-300 hover:bg-[#031A34] ${
        ...
        <p className="text-[11px] leading-relaxed text-gray-500">
          ...
          <a href="/privacy-policy" className="text-[#F9B122] underline" target="_blank" rel="noopener noreferrer">
            Privacy Policy
          </a>
          .
        </p>
