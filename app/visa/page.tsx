  ...
  return (
    <div className="page-spacing-wrapper">
        ...
        <div className="animated-block-target">
          <Container className="py-16 lg:py-20">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-10 xl:gap-12">
              {/* Text Card */}
              <div className="bg-gray-100 relative flex min-h-[500px] flex-col p-5 text-[#031A34] rounded-lg lg:p-10">
                <div className="z-10 flex flex-col gap-5">
                  ...
                  <div className="text-lg space-y-4">
                    ...
                    <p>
                      ...
                      <Link
                        ...
                        target="_blank"
                        className="text-orange-500 hover:text-[#031A34] transition-colors"
                      >
                  ...
                  <div className="flex w-full flex-wrap gap-5">
                    ...
                    >
                      <button className="transition-all duration-300 overflow-hidden bg-orange-500 px-8 py-3 font-bebas text-xl text-white hover:bg-[#031A34] rounded">
      ...
      <div className="animated-block">
        <div className="animated-block-target">
          <Container className="py-16 lg:py-20">
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold py-10 text-[#031A34] text-center">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                      ...
                      <li>
                        <Link
                          ...
                          target="_blank"
                          className="text-orange-500 hover:text-[#031A34] transition-colors font-bold"
                        >
                          WhatsApp
                        </Link>
                      </li>
