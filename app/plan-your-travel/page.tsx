          ...
          <div className="animated-block-target">
            <Container>
              <div className="mb-10 border-l-4 border-[#D4A72C] pl-6">
                ...
                <p className="mt-2 text-sm font-bold uppercase tracking-wider text-[#D4A72C]">
                ...
                <div className="mt-12 grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-5">
                  {quickLinks.map((item, idx) => (
                    ...
                    >
                      ...
                      >
                        <div className="flex h-16 w-16 items-center justify-center rounded-sm bg-gray-800 transition-colors group-hover:bg-[#D4A72C]">
                          <div className="text-2xl">{item.icon}</div>
                        </div>

                        <p className="mt-4 text-xs font-bold uppercase tracking-wider text-gray-300 transition-colors group-hover:text-[#D4A72C]">
                          {item.label}
                        </p>
                      </Link>
                    </div>
