            ...
            <div className="flex flex-col gap-6 lg:sticky h-fit lg:top-[calc(var(--site-header-height,13.75rem)+1rem)]">
              <div className="space-y-3">
                ...
                <h1 className="font-bebas text-5xl sm:text-6xl leading-[1.05] tracking-tight uppercase text-[#0E2044]">
                  Unlock Market <span className="text-[#D4A72C]">Opportunities</span>
                </h1>
              </div>
              ...
              <div className="space-y-5 pt-2">
                {[
                  ...
                  <div key={i} className="flex gap-3">
                    <div className="w-6 h-6 border border-gray-150 bg-white rounded-sm flex items-center justify-center text-[#D4A72C] text-xs font-bold mt-0.5 shrink-0">
                      ✓
                    </div>
                    <div>
            ...
            <div className="bg-[#FCF8F3] border border-gray-100 rounded-sm p-6 md:p-8 shadow-sm">
              <div className="mb-6">
                <h3 className="text-[#0E2044] font-bebas text-3xl mb-1 uppercase tracking-wide font-bold">
                  Get The Free <span className="text-[#D4A72C]">Market Report</span>
                </h3>
