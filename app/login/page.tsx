        ...
        <div className="rounded-sm border border-white/15 bg-white/10 p-5 shadow-2xl backdrop-blur-xl sm:rounded-2xl sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full rounded-sm border border-white/20 bg-white px-4 py-3 text-gray-900 placeholder-gray-400 transition focus:border-[#D4A72C] focus:outline-none focus:ring-2 focus:ring-[#D4A72C]"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-sm border border-white/20 bg-white px-4 py-3 pr-12 text-gray-900 placeholder-gray-400 transition focus:border-[#D4A72C] focus:outline-none focus:ring-2 focus:ring-[#D4A72C]"
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="h-4 w-4 rounded-sm border-white/20 bg-white text-[#D4A72C] focus:ring-[#D4A72C]"
                />
                <span className="text-sm text-gray-300">Remember me</span>
              </label>
              <Link
                href="/exhibitor/forgot-password"
                className="text-sm text-[#D4A72C] transition hover:text-[#FFD154]"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-gray-400">
              ...
              <Link href="/exhibitor/register" className="text-[#D4A72C] transition hover:text-[#FFD154]">
