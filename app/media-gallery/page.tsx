        ...
        <Container>
          <div className="border-b border-gray-250 pb-6 mb-8 mt-10">
            <h1 className="font-bebas text-5xl sm:text-6xl text-[#0E2044] uppercase tracking-wide">
              A Visual Journey Through <span className="text-[#B89646]">INDIAMET Expo</span>
            </h1>
              ...
              >
                <div className="relative h-[280px] sm:h-[320px] overflow-hidden bg-gray-100 rounded-sm">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    <h3 className="font-bebas text-2xl text-white uppercase group-hover:text-[#B89646] transition-colors duration-300 font-bold tracking-wide">
                      {category.title}
                    </h3>
                  </div>
                </div>
