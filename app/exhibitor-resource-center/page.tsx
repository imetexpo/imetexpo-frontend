      ...
      <div className="page-spacing-wrapper lg:pt-0">
          ...
          <div className="animated-block mt-8 sm:mt-12 lg:mt-16">
            <div className="animated-block-target">
              <h2 className="font-bebas text-4xl sm:text-5xl md:text-6xl text-[#031A34] uppercase">
                Stands for your <span className="text-[#F9B122]">Business Objectives</span>
              </h2>
        ...
        <Container className="py-10">
          <div className="animated-block mt-8 sm:mt-12 lg:mt-16">
            <div className="animated-block-target">
              <h2 className="font-bebas text-4xl sm:text-5xl md:text-6xl text-[#031A34] uppercase">
                Explore Our <span className="text-[#F9B122]">Stand Options</span>
              </h2>
              <p className="mt-2 text-sm font-bold text-[#F9B122] uppercase tracking-wider">Selection Made Simple</p>
              <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="animated-block mt-12 sm:mt-16 lg:mt-20">
          <div className="animated-block-target">
            <div className="bg-[#FCF8F3] py-16 border-t border-b border-gray-150">
              <Container>
                <h2 className="font-bebas text-4xl sm:text-5xl md:text-6xl text-[#031A34] uppercase">
                  Exhibition <span className="text-[#F9B122]">Guide</span>
                </h2>
                    ...
                    <div key={idx} className="rounded-sm border border-gray-100 bg-white overflow-hidden shadow-sm">
                      ...
                      >
                        ...
                        <div className="relative shrink-0">
                          ...
                          >
                            <path d="M8 2.75C8 2.47386 7.77614 2.25 7.5 2.25C7.22386 2.25 7 2.47386 7 2.75V7H2.75C2.47386 7 2.25 7.22386 2.25 7.5C2.25 7.77614 2.47386 8 2.75 8H7V12.25C7 12.5261 7.22386 12.75 7.5 12.75C7.77614 12.75 8 12.5261 8 12.25V8H12.25C12.5261 8 12.75 7.77614 12.75 7.5C12.75 7.22386 12.5261 7 12.25 7H8V2.75Z" fill="#F9B122" fillRule="evenodd" clipRule="evenodd"></path>
                          </svg>
                        </div>
                      </button>
                      {openFaqIndex === idx && (
