    ...
    return (
      <div className="page-spacing-wrapper lg:pt-0">
        <Container className="py-20 text-center">
          <h1 className="font-bebas text-5xl text-[#0E2044] md:text-6xl lg:text-7xl">
            Sector Not Found
          </h1>
          ...
          <Link href="/sectors">
            <button className="mt-8 bg-[#B89646] hover:bg-[#0E2044] text-white px-8 py-3 text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm">
              Back to All Sectors
            </button>
          </Link>
        </Container>
      ...
      <div className="page-spacing-wrapper lg:pt-0">
          ...
          <div className="animated-block-target">
            <Container>
              <div className="space-y-5 py-10">
                <h1 className="font-bebas text-5xl text-[#0E2044] md:text-6xl lg:text-7xl uppercase">
                  {sector.title}
                </h1>
        ...
        {sector.subSectors && sector.subSectors.length > 0 && (
          <div className="animated-block mt-12">
            <div className="animated-block-target">
              <Container>
                <h2 className="mb-8 font-bebas text-4xl text-[#0E2044] md:text-5xl uppercase">
                  Sub-Sectors Within <span className="text-[#B89646]">{sector.title}</span>
                </h2>
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {sector.subSectors.map((sub, idx) => (
                    <div key={idx} className="rounded-sm border border-gray-100 bg-[#FCF8F3] p-6 shadow-sm transition-all hover:shadow-md">
                      <h3 className="mb-3 font-bebas text-2xl text-[#B89646] uppercase font-bold">
                        {sub.title}
                      </h3>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                  {sector.keyProducts.map((product, idx) => (
                    <div key={idx} className="flex items-center gap-2 rounded-sm bg-[#FCF8F3] border border-gray-100 p-3">
                      <span className="text-xl text-[#B89646]">✓</span>
          ...
          <div className="animated-block-target">
            <Container>
              <div className="mb-10 text-center lg:mb-12 lg:text-left">
                <p className="font-bold text-[#B89646] uppercase text-xs tracking-wider">Quick Guide</p>
                <h3 className="mt-2 font-bebas text-5xl text-[#0E2044] md:text-6xl lg:text-7xl uppercase">
                ...
                {quickGuideItems.map((item, idx) => (
                  ...
                  >
                    <div className="relative h-48 w-full overflow-hidden">
                      ...
                      />
                      <div className="absolute inset-0 bg-[#0E2044]/20 transition-all duration-300 group-hover:bg-[#0E2044]/40"></div>
                    ...
                    <div className="flex flex-1 flex-col gap-3 p-5 font-sans">
                      <h4 className="font-bebas text-2xl text-[#0E2044] md:text-3xl font-bold uppercase">
                        {item.title}
                      </h4>
        ...
        <div className="animated-block mt-8">
          <Container>
            <Link href="/sectors">
              <button className="flex items-center gap-2 text-[#B89646] transition-all hover:gap-3 hover:text-[#0E2044] font-sans font-medium text-sm">
