        ...
        <div className="flex justify-between">
          ...
          <button className="z-10" aria-label="Menu">
            <svg width="32" height="20" viewBox="0 0 32 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1.66667 20C0.746193 20 0 19.2538 0 18.3333C0 17.4129 0.746193 16.6667 1.66667 16.6667H30.3333C31.2538 16.6667 32 17.4129 32 18.3333C32 19.2538 31.2538 20 30.3333 20H1.66667ZM1.66667 11.6667C0.746193 11.6667 0 10.9205 0 10C0 9.07952 0.746192 8.33333 1.66667 8.33333H30.3333C31.2538 8.33333 32 9.07952 32 10C32 10.9205 31.2538 11.6667 30.3333 11.6667H1.66667ZM1.66667 3.33333C0.746193 3.33333 0 2.58714 0 1.66667C0 0.746192 0.746192 0 1.66667 0H30.3333C31.2538 0 32 0.746192 32 1.66667C32 2.58714 31.2538 3.33333 30.3333 3.33333H1.66667Z" fill="#F9B122"></path>
            </svg>
          </button>
        </div>
      </div>
                  ...
                  {sectors.map((sector, idx) => (
                    ...
                    >
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent p-4 pt-8 rounded-b-sm">
                        <h3 className="text-center font-bebas text-lg sm:text-xl text-white transition-colors duration-300 group-hover:text-[#F9B122] font-bold uppercase tracking-wide">
                          {sector.title}
                        </h3>
                      </div>
                    </Link>
          ...
          <div className="animated-block-target">
            <Container>
              <div className="mb-10 text-center lg:mb-12 lg:text-left">
                <p className="font-bold text-[#F9B122]">Quick Guide</p>
