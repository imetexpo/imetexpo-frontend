    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center font-sans">
        <div className="text-center">
          <Loader2 className="w-12 h-12 animate-spin text-[#D4A72C] mx-auto mb-4" />
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center font-sans">
        <div className="text-center">
          ...
          <button
            ...
            className="bg-[#D4A72C] hover:bg-[#031A34] text-white px-6 py-2.5 text-xs font-bold uppercase tracking-wider transition-all duration-300 rounded-sm cursor-pointer"
          >
            Back to Directory
          </button>
        </div>
          ...
          <div className="flex items-center justify-between py-3">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <Link
                ...
                className="px-6 py-2 bg-[#D4A72C] hover:bg-[#031A34] text-white rounded-sm font-bold text-xs uppercase tracking-wider transition-colors"
              >
            ...
            <div>
              ...
              <div className="p-4 space-y-3 flex flex-col">
                <button
                  ...
                  className="w-full py-3 px-4 bg-[#D4A72C] text-white rounded-sm font-bold text-xs uppercase tracking-wider cursor-pointer hover:bg-[#031A34] transition-colors"
                >
                  Back to Exhibitor List
                </button>
                <button
              ...
              <div className="flex-1 space-y-4 text-center lg:text-left">
                ...
                <div>
                  <div className="inline-flex items-center gap-3 bg-white border border-gray-150 px-4 py-2.5 rounded-sm">
                    ...
                    <span className="text-xl font-bold text-[#D4A72C]">#{company.standNumber}</span>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex flex-wrap gap-1.5 justify-center lg:justify-start">
                    {company.sector.map((sector: string, index: number) => (
                      <span
                        key={index}
                        className="bg-[#D4A72C] text-white px-3 py-1 rounded-sm text-[10px] font-bold uppercase tracking-wider"
                      >
                        {sector}
                      </span>
                    ))}
                ...
                <div className="pt-4 border-t border-gray-200 flex flex-wrap items-center justify-center lg:justify-start gap-6">
                  {company.website && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-[#D4A72C] font-sans font-bold text-xs uppercase tracking-wider hover:text-[#031A34] transition-colors"
                    >
                      <Globe size={16} />
        ...
        <Container className="mt-8">
          <div className="flex flex-wrap gap-2 items-center">
            ...
            <button
              ...
              className="px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-white bg-[#D4A72C] border border-[#D4A72C] rounded-sm hover:bg-[#031A34] hover:border-black transition-colors flex items-center gap-2 ml-auto cursor-pointer"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-[#FCF8F3] border border-gray-100 rounded-sm p-6 shadow-sm">
                  ...
                  <ul className="space-y-3 font-sans">
                    ...
                    <li className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-white border border-gray-150 rounded-sm flex items-center justify-center flex-shrink-0">
                        <Building size={18} className="text-[#D4A72C]" />
                      </div>
                      <div>
              ...
              {products.length > 0 ? (
                products.map((product) => (
                  <div key={product.id} className="bg-[#FCF8F3] border border-gray-100 rounded-sm p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center text-center justify-between">
                    ...
                    {product.price && (
                      <div className="mt-4">
                        <span className="inline-block bg-[#D4A72C] text-white px-3 py-1 rounded-sm text-xs font-bold uppercase tracking-wider">
                          {product.price}
                        </span>
                      </div>
                    )}
                              ...
                              {brochureUrl ? (
                                <div className="flex flex-col sm:flex-row gap-2">
                                  <button
                                    ...
                                    className="px-3 py-2 bg-[#D4A72C] text-white rounded-sm text-xs font-bold uppercase tracking-wider hover:bg-[#031A34] transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                                  >
                                    <Eye size={14} /> View
                                  </button>
                                  <a
        ...
        <Container className="mt-8">
          <div className="bg-[#02162E] border border-gray-100 rounded-sm p-6 shadow-sm flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/exhibition-directory"
                className="px-5 py-2.5 rounded-sm text-xs font-bold uppercase tracking-wider transition-colors text-white bg-[#D4A72C] hover:bg-[#031A34]"
              >
