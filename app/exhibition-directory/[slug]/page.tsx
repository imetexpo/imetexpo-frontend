...
export default function ExhibitorDetailPage() {
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center font-sans">
        <div className="text-center">
          <Loader2 className="w-12 h-12 animate-spin text-[#F9B122] mx-auto mb-4" />
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center font-sans">
        <div className="text-center">
          ...
          <button
            ...
            className="bg-[#F9B122] hover:bg-[#031A34] text-white px-6 py-2.5 text-xs font-bold uppercase tracking-wider transition-all duration-300 rounded-sm cursor-pointer"
          >
            Back to Directory
          </button>
        </div>
  ...
  return (
    <div className="intro-animation bg-white min-h-screen font-sans">
          ...
          <div className="flex items-center justify-between py-3">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <Link
                ...
                className="px-6 py-2 bg-[#F9B122] hover:bg-[#031A34] text-white rounded-sm font-bold text-xs uppercase tracking-wider transition-colors"
              >
      ...
      {/* Mobile Menu Overlay */}
      {showMobileMenu && (
        <div className="fixed inset-0 z-40 bg-[#031A34] bg-opacity-50 lg:hidden">
            ...
            <div>
              <div className="p-6 border-b border-gray-255">
                <div className="flex justify-between items-center">
                  <h3 className="font-bebas text-2xl font-bold uppercase text-[#031A34]">Navigation</h3>
                  <button
              ...
              <div className="p-4 space-y-3 flex flex-col">
                <button
                  ...
                  className="w-full py-3 px-4 bg-[#F9B122] text-white rounded-sm font-bold text-xs uppercase tracking-wider cursor-pointer hover:bg-[#031A34] transition-colors"
                >
                  Back to Exhibitor List
                </button>
                <button
      ...
      {/* PDF Viewer Modal */}
      {selectedPdf && (
        <div className="fixed inset-0 z-50 bg-[#031A34] bg-opacity-75 flex items-center justify-center p-4">
      ...
      <div className="pt-6 pb-16">
          ...
          <div className="bg-[#FCF8F3] border border-gray-100 rounded-sm shadow-sm overflow-hidden p-6 sm:p-8">
            <div className="flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-10">
              ...
              <div className="flex-1 space-y-4 text-center lg:text-left">
                <div>
                  <h1 className="font-bebas text-4xl sm:text-5xl lg:text-6xl font-bold text-[#031A34] uppercase leading-tight">
                    {company.name}
                  </h1>
                  {company.shortName && (
                ...
                <div>
                  <div className="inline-flex items-center gap-3 bg-white border border-gray-150 px-4 py-2.5 rounded-sm">
                    ...
                    <span className="text-xl font-bold text-[#F9B122]">#{company.standNumber}</span>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex flex-wrap gap-1.5 justify-center lg:justify-start">
                    {company.sector.map((sector: string, index: number) => (
                      <span
                        key={index}
                        className="bg-[#F9B122] text-white px-3 py-1 rounded-sm text-[10px] font-bold uppercase tracking-wider"
                      >
                        {sector}
                      </span>
                    ))}
                ...
                <div className="pt-4 border-t border-gray-200 flex flex-wrap items-center justify-center lg:justify-start gap-6">
                  {company.website && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-[#F9B122] font-sans font-bold text-xs uppercase tracking-wider hover:text-[#031A34] transition-colors"
                    >
                      <Globe size={16} />
        ...
        <Container className="mt-8">
          <div className="flex flex-wrap gap-2 items-center">
              ...
              return (
                <button
                  ...
                  className={`px-5 py-2.5 rounded-sm font-bold border transition-colors flex items-center gap-2 text-xs uppercase tracking-wider cursor-pointer ${isActive
                      ? 'bg-[#F9B122] text-white border-[#F9B122]'
            ...
            <button
              ...
              className="px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-white bg-[#F9B122] border border-[#F9B122] rounded-sm hover:bg-[#031A34] hover:border-black transition-colors flex items-center gap-2 ml-auto cursor-pointer"
            >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-[#FCF8F3] border border-gray-100 rounded-sm p-6 shadow-sm">
                  <h3 className="font-bebas text-2xl text-[#031A34] mb-4 uppercase">Location Details</h3>
                  <ul className="space-y-3 font-sans">
                    <li className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-white border border-gray-150 rounded-sm flex items-center justify-center flex-shrink-0">
                        <MapPin size={18} className="text-[#F9B122]" />
                      </div>
                      <div>
                    ...
                    <li className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-white border border-gray-150 rounded-sm flex items-center justify-center flex-shrink-0">
                        <Building size={18} className="text-[#F9B122]" />
                      </div>
                      <div>
                ...
                <div className="bg-[#FCF8F3] border border-gray-100 rounded-sm p-6 shadow-sm">
                  <h3 className="font-bebas text-2xl text-[#031A34] mb-4 uppercase">Sectors & Specialties</h3>
                  ...
                  {company.contactPerson && (company.contactPerson.name || company.contactPerson.email || company.contactPerson.phone) && (
                    <div className="pt-4 border-t border-gray-200">
                      <h4 className="font-bebas text-2xl text-[#031A34] mb-3 uppercase">Contact Person</h4>
                      <div className="space-y-2 text-sm font-sans text-slate-700">
                        {company.contactPerson.name && (
                          <p>
                            <span className="font-bold text-[#031A34]">Name:</span> {company.contactPerson.name}
                          </p>
                        )}
                        {company.contactPerson.jobTitle && (
                          <p>
                            <span className="font-bold text-[#031A34]">Title:</span> {company.contactPerson.jobTitle}
                          </p>
                        )}
                        {company.contactPerson.email && (
                          <p>
                            <span className="font-bold text-[#031A34]">Email:</span> {company.contactPerson.email}
                          </p>
                        )}
                        {company.contactPerson.phone && (
                          <p>
                            <span className="font-bold text-[#031A34]">Phone:</span> {company.contactPerson.phone}
                          </p>
                        )}
                      </div>
                    </div>
                ...
                products.map((product) => (
                  <div key={product.id} className="bg-[#FCF8F3] border border-gray-100 rounded-sm p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center text-center justify-between">
                    <div>
                      ...
                      <h3 className="font-bebas text-2xl text-[#031A34] mb-2 uppercase font-bold">
                    ...
                    {product.price && (
                      <div className="mt-4">
                        <span className="inline-block bg-[#F9B122] text-white px-3 py-1 rounded-sm text-xs font-bold uppercase tracking-wider">
                          {product.price}
                        </span>
                      </div>
                    )}
                  ...
                  <div key={brand.id || index} className="bg-[#FCF8F3] border border-gray-100 rounded-sm p-6 shadow-sm hover:shadow-md transition-all duration-300">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="min-w-0">
                        <h3 className="font-bebas text-2xl text-[#031A34] truncate uppercase font-bold">{brand.name || company.name}</h3>
                        {brand.description && (
                              ...
                              {brochureUrl ? (
                                <div className="flex flex-col sm:flex-row gap-2">
                                  <button
                                    ...
                                    className="px-3 py-2 bg-[#F9B122] text-white rounded-sm text-xs font-bold uppercase tracking-wider hover:bg-[#031A34] transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                                  >
                                    <Eye size={14} /> View
                                  </button>
                                  <a
                                    ...
                                    className="px-3 py-2 bg-slate-800 text-white rounded-sm text-xs font-bold uppercase tracking-wider hover:bg-[#031A34] transition-colors flex items-center justify-center gap-1.5"
                                  >
        ...
        {/* BOTTOM NAVIGATION */}
        <Container className="mt-8">
          <div className="bg-[#02162E] border border-gray-100 rounded-sm p-6 shadow-sm flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <button
                onClick={handlePrevious}
              ...
              <Link
                href="/exhibition-directory"
                className="px-5 py-2.5 rounded-sm text-xs font-bold uppercase tracking-wider transition-colors text-white bg-[#F9B122] hover:bg-[#031A34]"
              >
