    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#FCF8F3] font-sans">
        <div className="text-center">
          <Loader2 className="mx-auto mb-4 h-12 w-12 animate-spin text-[#F9B122]" />
    ...
    <div className="intro-animation min-h-screen bg-white font-sans">
      ...
      >
        <Link
          ...
          className="inline-block rounded-sm bg-[#F9B122] px-6 py-3 text-xs font-bold uppercase tracking-wider text-white transition-all duration-300 hover:bg-[#FFD154]"
        >
        ...
        <Container>
            ...
            <div className="mb-4 flex flex-wrap gap-1.5 sm:gap-2">
              <button
                ...
                className={`cursor-pointer rounded-sm px-3 py-2 text-xs font-bold uppercase tracking-wider transition-colors sm:px-4 ${
                  !selectedLetter
                    ? 'border border-[#F9B122] bg-[#F9B122] text-white'
          ...
          <div className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-sm border border-gray-300 bg-white py-3 pl-10 pr-10 text-sm focus:border-[#F9B122] focus:outline-none focus:ring-1 focus:ring-[#F9B122]"
              />
              {searchQuery && (
                <button
                  onClick={() => {
          ...
          {loading ? (
            <div className="flex justify-center py-12">
              <Loader2 className="h-8 w-8 animate-spin text-[#F9B122]" />
            </div>
          ) : (
            <CompanyGrid
          ...
          {!loading && filteredCompanies.length === 0 && (
            <div className="mx-auto mt-10 max-w-md rounded-sm border border-gray-100 bg-[#FCF8F3] py-16 text-center shadow-sm">
              ...
              <button
                ...
                className="mt-6 cursor-pointer rounded-sm bg-[#F9B122] px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-white transition-all duration-300 hover:bg-[#031A34]"
              >
                Clear all filters
              </button>
            </div>
