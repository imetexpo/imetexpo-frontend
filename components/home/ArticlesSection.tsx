            ...
            <div className="lg:w-[65%] group cursor-pointer min-w-0">
              ...
              <div className="mt-4">
                ...
                <Link href={`/articles/${featuredArticle.slug}`}>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[#0E2044] mt-2 leading-snug hover:text-[#D4A72C] transition">
              ...
              <div key={article.slug} className="grid grid-cols-[35%_65%] sm:grid-cols-[40%_60%] gap-3 sm:gap-4 items-start group cursor-pointer">
                ...
                <div>
                  ...
                  <Link href={`/articles/${article.slug}`}>
                    <h4 className="text-xs sm:text-sm md:text-base font-bold text-[#0E2044] mt-1 leading-snug hover:text-[#D4A72C] transition line-clamp-2">
                      {article.title}
                    </h4>
                  </Link>
