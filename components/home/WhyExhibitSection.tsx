        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-stretch">
          ...
          <div className="flex-1 flex flex-col gap-5 justify-between">
            <div className="flex flex-col gap-4">
              <div className="flex flex-col">
                <h2 className="font-bebas text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-none tracking-tight text-[#F9B122] uppercase">
                  WHY EXHIBIT
                </h2>
            ...
            <Link
              href="/why-exhibit/"
              className="inline-block bg-[#F9B122] hover:bg-white hover:text-[#031A34] text-white px-8 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm mt-6 w-fit text-center"
            >
          ...
          <div className="flex-1 flex flex-col justify-center">
            {reasons.map((text, index) => (
              ...
              >
                <span className="text-[#F9B122] text-sm sm:text-base font-bold font-sans flex-shrink-0 mt-1">
                  0{index + 1}.
                </span>
