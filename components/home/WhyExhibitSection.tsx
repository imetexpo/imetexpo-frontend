        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-stretch">
          ...
          <div className="flex-1 flex flex-col gap-5 justify-between">
            <div className="flex flex-col gap-4">
              <div className="flex flex-col">
                <h2 className="font-bebas text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-none tracking-tight text-[#D4A72C] uppercase">
                  WHY EXHIBIT
                </h2>
          ...
          <div className="flex-1 flex flex-col justify-center">
            {reasons.map((text, index) => (
              ...
              >
                <span className="text-[#D4A72C] text-sm sm:text-base font-bold font-sans flex-shrink-0 mt-1">
                  0{index + 1}.
                </span>
