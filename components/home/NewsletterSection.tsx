      ...
      <Container>
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-10">
          ...
          <div className="flex-shrink-0">
            <Button
              href="/newsletter/"
              className="bg-[#B89646] hover:bg-white hover:text-[#0E2044] text-white px-8 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm w-full sm:w-auto text-center"
            >
              SIGN UP TODAY
            </Button>
          </div>
