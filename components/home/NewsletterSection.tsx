      ...
      <Container>
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-10">
          ...
          <div className="flex-shrink-0">
            <Button
              href="/newsletter/"
              className="bg-[#D4A72C] hover:bg-white hover:text-[#031A34] text-white px-8 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm w-full sm:w-auto text-center"
            >
              SIGN UP TODAY
            </Button>
          </div>
