...
export default function NewsletterSection() {
  return (
    <section className="bg-[#0E2044] py-16 sm:py-20 lg:py-24 text-white border-t border-white/10">
      <Container>
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-10">
          ...
          <div className="flex-shrink-0">
            <Button
              href="/newsletter/"
              className="bg-[#D4A72C] hover:bg-white hover:text-[#0E2044] text-white px-8 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm w-full sm:w-auto text-center"
            >
              SIGN UP TODAY
            </Button>
          </div>
