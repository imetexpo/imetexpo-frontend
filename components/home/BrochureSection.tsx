...
export default function BrochureSection() {
  return (
    <section className="relative overflow-hidden py-16 sm:py-20 lg:py-28 text-white">
      ...
      />
      <div className="absolute inset-0 bg-[#03193D]/70" />
      ...
      <Container className="relative z-10">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-4 sm:gap-5 lg:gap-6 text-center lg:text-left">
            ...
            <Button
              href="/event-brochure/"
              className="bg-[#CC9808] hover:bg-white hover:text-[#03193D] text-white px-8 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 rounded-sm w-fit mx-auto lg:mx-0"
            >
