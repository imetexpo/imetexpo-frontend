            ...
            <Container className="flex items-center justify-between py-3.5">
              ...
              <div className="hidden sm:flex gap-3">
                <UTMLink
                  ...
                  className="bg-[#CC9808] hover:bg-[#B6B8BA] text-white text-center px-6 py-2 text-xs font-bold uppercase tracking-wider transition-all duration-300 whitespace-nowrap rounded-sm"
                >
                  Exhibit
                </UTMLink>
                <UTMLink
